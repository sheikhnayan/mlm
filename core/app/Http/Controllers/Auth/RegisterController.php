...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm(Request $request)
    {
        ...
        if ($request->ref && $request->position && $request->bv) {
            ...
            $join_under = User::find($request->bv);
            ...
            $page_title = "Sign Up";
            return view($this->activeTemplate . 'user.auth.register', compact('page_title', 'ref_user', 'joining', 'content',  'position', 'country_code','join_under'));
    ...
    {  
        ...
        if($request->random == 'not_random'){
            $bvCheck = User::where('pos_id', $request->bv)->where('position', $request->position)->first();

        if (!$bvCheck)
        {
            $notify[] = ['error', 'You can not join under this user in this position.'];
    ...
    protected function create(array $data)
    {
        ...
        $user->pos_id       = isset($data['bv']) ? $data['bv'] : $pos['pos_id'];
