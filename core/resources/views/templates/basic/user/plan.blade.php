...
@section('panel')
                    ...
                    <div class="card-body pt-5 pb-5 ">
                        <div class="pricing-table text-center mb-4">
                            ...
                            <ul class="package-features-list mt-30">
                                ...
                                <li>
                                    <i class="fas @if(getAmount($data->daily_com) != 0) fa-check bg--success @else fa-times bg--danger @endif "></i>  <span>@lang('Daily Commission'): {{$general->cur_sym}} {{getAmount($data->daily_com)}}% </span>
                                     <span class="icon" data-toggle="modal" data-target="#dailyComInfoModal"><i
                                    class="fas fa-question-circle"></i></span>
                                </li>
                                <li>
                                    <i class="fas @if(getAmount($data->weekly_com) != 0) fa-check bg--success @else fa-times bg--danger @endif "></i>  <span>@lang('Weekly Commission'): {{$general->cur_sym}} {{getAmount($data->weekly_com)}}% </span>
                                     <span class="icon" data-toggle="modal" data-target="#weeklyComInfoModal"><i
                                    class="fas fa-question-circle"></i></span>
                                </li>
                                <li>
                                    <i class="fas @if(getAmount($data->monthly_com) != 0) fa-check bg--success @else fa-times bg--danger @endif "></i>  <span>@lang('Monthly Commission'): {{$general->cur_sym}} {{getAmount($data->monthly_com)}}% </span>
                                     <span class="icon" data-toggle="modal" data-target="#monthlyComInfoModal"><i
                                    class="fas fa-question-circle"></i></span>
                                </li>
                                <li>
                                    <i class="fas @if(getAmount($data->min_amount) != 0) fa-check bg--success @else fa-times bg--danger @endif "></i>  <span>@lang('Minimum Deposit'): {{$general->cur_sym}} {{getAmount($data->min_amount)}} </span>
                                     <span class="icon" data-toggle="modal" data-target="#min_deposit"><i
                                    class="fas fa-question-circle"></i></span>
                                </li>
                                <li>
                                    <i class="fas @if(getAmount($data->max_amount) != 0) fa-check bg--success @else fa-times bg--danger @endif "></i>  <span>@lang('Maximum Deposit'): {{$general->cur_sym}} {{getAmount($data->max_amount)}} </span>
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" action="{{route('user.plan.purchase')}}">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="number" max="{{getAmount($data->max_amount)}}" min="{{getAmount($data->min_amount)}}" class=""form-control name="amount"> 
                            </div>
    ...
    <div class="modal fade" id="treeComInfoModal">
     ...
     <div class="modal fade" id="dailyComInfoModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Daily Commission info')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <h5 class=" text-danger">@lang('When someone buys this plan, He will get this amount comission added to his wallet daily'). </h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
                </div>
    ...
    <div class="modal fade" id="weeklyComInfoModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Weekly Commission info')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <h5 class=" text-danger">@lang('When someone buys this plan, He will get this amount comission added to his wallet weekly'). </h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
                </div>
    ...
    <div class="modal fade" id="monthlyComInfoModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Monthly Commission info')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <h5 class=" text-danger">@lang('When someone buys this plan, He will get this amount comission added to his wallet monthly'). </h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
                </div>
    ...
    <div class="modal fade" id="min_deposit">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Minimum Deposit info')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <h5 class=" text-danger">@lang('If Someone wants to but this,He have to minimum this amount!  '). </h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
                </div>
    ...
    <div class="modal fade" id="max_deposit">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Maximum Deposit info')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <h5 class=" text-danger">@lang('If Someone wants to but this,He have to maximum this amount!  '). </h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
                </div>
